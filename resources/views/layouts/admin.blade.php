...
<head>
  ...
  <title>MeroLunch Admin Dashboard</title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{route('admins.index')}}" class="brand-link">
      <img src="admin/dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">Admin MeroLunch</span>
    </a>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2020 <a href="https://merolunch.com/">MeroLunch</a>.</strong>
    All rights reserved.
